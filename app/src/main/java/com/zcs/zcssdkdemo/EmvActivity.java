...
import com.zcs.zcssdkdemo.utils.FileUtils;
...
public class EmvActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        listItems[0] = getString(R.string.pref_magnetic_card);
        listItems[1] = getString(R.string.pref_IC_card);
        listItems[2] = getString(R.string.pref_contactless_card);
