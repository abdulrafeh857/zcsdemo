...
public class Ntagctivity extends BaseActivity implements View.OnClickListener {
    ...
    private RfCard mRfCard = DriverManager.getInstance().getCardReadManager().getRFCard();
    private ExecutorService mExecutor = DriverManager.getInstance().getSingleThreadExecutor();
